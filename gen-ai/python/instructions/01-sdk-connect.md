...
If you have not already cloned the lab code repository for **Build copilots with Azure Cosmos DB** and set up your local environment, view the [Setup local lab environment]({% link gen-ai/python/instructions/00-setup-lab-environment.md %}) instructions to do so.
